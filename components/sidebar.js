...
const Sidebar = ({ borderWidth, setBorderWidth, borderHeight, setBorderHeight, padding, setPadding, size, setSize, mode, setMode}) => {
  ...
  return (
    <div className="sidebar sidebar-container open">
      <div className="sidebar sidebar-sliders-wrap">
        ...
        <div >
        <label>
            <input type="radio" name="mode" value="BOTTOM_AXIS" checked={mode === "BOTTOM_AXIS"} onChange={changeRadio}/>
            Bottom axis
        </label>
        </div>
        <div>
        <label>
            <input type="radio" name="mode" value="SYMMETRY" checked={mode === "SYMMETRY"} onChange={changeRadio}/>
            Symmetry
        </label>
        </div>
        </div>
